        ...
        switch (opcao) {
            ...
            case 1:
                ...
                if (strcmp(cargo, "Administrador") == 0 || strcmp(cargo, "administrador") == 0) {
                    ...
                    novoAdm->salario = 5000;                                                     // Aloca memória para novo administrador
                    novoAdm->Adm = NULL;
                    ...
                    novoAdm->Adm = listaAdm;                   // Encadeia na lista
                    listaAdm = novoAdm;
                    ...
                    novoFunc->salario = 3500;                                               // Aloca memória para novo funcionario
                    novoFunc->Func = NULL;                                   
            ...
            case 2:
                ...
                while (atual_adm != NULL) {
                    ...
                    if (strcmp(busca_nome, atual_adm->nome) == 0) {
                        ...
                        if (busca_senha == atual_adm->senha) {                            // Percorre lista de administradores
                                                                                      
                            printf("\nAcesso validado!!\n");
                            printf("\nAdministrador(a): %s\n", atual_adm->nome);
                            printf("Nascido(a) em %d/%d/%d\n", atual_adm->dia, atual_adm->mes, atual_adm->ano);
                            printf("Cargo: %s\n", atual_adm->cargo);
                            printf("Salario: R$ %.2f\n", atual_adm->salario);
                ...
                while (atual_func != NULL) {
                    ...
                    if (strcmp(busca_nome, atual_func->nome) == 0) {
                        ...
                        if (busca_senha == atual_func->senha) {

                            printf("\nAcesso validado!!\n");
                            printf("\nFuncionario(a): %s\n", atual_func->nome);
                            printf("Nascido(a) em %d/%d/%d\n", atual_func->dia, atual_func->mes, atual_func->ano);             // Percorre lista de funcionarios
                            printf("Cargo: %s\n", atual_func->cargo);
                            printf("Salario: R$ %.2f\n", atual_func->salario);
